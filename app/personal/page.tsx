      ...
      <header className="relative w-full bg-[url('/hero2.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className="container py-20 px-4 md:px-6 relative z-10 text-center text-white">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg leading-relaxed">
            Our team of experienced Atlanta Personal Injury attorneys is
            dedicated to providing the highest level of legal representation for
          ...
          <div className="flex flex-col items-center md:flex-row md:space-x-8">
            <div className="md:w-1/2">
              ...
              <p className="mt-4 text-lg">
                Kashlan Law is a personal injury law firm dedicated to providing
                exceptional legal representation and support to individuals who
                have suffered injuries due to the negligence of others in
                Atlanta. With a strong commitment to justice and a track record
                of success, our firm has become a trusted ally for those in need
                of legal assistance in personal injury cases.
              </p>
              <h2 className="mt-8 text-2xl font-bold">Our Mission</h2>
              <p className="mt-4 text-lg">
                At Kashlan Law, our mission is clear: to help victims of
                personal injury seek the compensation and justice they deserve.
                We believe that everyone deserves a voice in the legal system,
                and we are dedicated to being that voice for our clients.
              </p>
            </div>
