interface CardData {
  ...
  const personalCardData: CardData[] = [
    {
      title: "Car Accidents",
      description:
    ...
    },
    {
      ...
      image: "/personal/wrongfuldeath.png",
    },
  ];
  
  export default personalCardData;  